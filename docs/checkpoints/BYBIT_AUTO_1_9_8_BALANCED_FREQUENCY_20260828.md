...
## Diagnostics
The VPS Adaptive Entry Review uses DEMO/public market routing so scan funnel diagnostics do not require production private Bybit credentials. It records analyzed, rawCandidates, qualified, correlation rejections and selected setup details without placing an order.
