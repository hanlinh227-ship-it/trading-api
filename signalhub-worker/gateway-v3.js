...
const V3_VERSION = 'SIGNALHUB-V3-GATEWAY-3.6.0';
...
const V31_RELEASE = {
  ...
  artifactName: 'SignalHub-Android-v3.6.0',
  notes: [
    'V3.6 Market Judgment Engine: no score gate, no minimum score, no RR admission threshold and no signal cooldown.',
