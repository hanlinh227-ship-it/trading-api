...
VNEXT_INTEGRATION_FILES: tuple[tuple[str, str], ...] = (
    ...
    ("AI_SKILL_LIBRARY/v4/tools/activate_brain_expansion.py", "brain_expansion_activation_runtime"),
    ("AI_SKILL_LIBRARY/v4/tools/merge_activation_reports.py", "brain_expansion_activation_merge_tool"),
)
