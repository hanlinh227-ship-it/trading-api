export const BYBIT_RUNTIME_CONTRACT_VERSION='BYBIT_BTC_RUNTIME_CONTRACT_V5';
export const BYBIT_AUTO_VERSION='BYBIT-BTC-STATEFLOW-2.3';
...
export const BYBIT_RUNTIME_CONTRACT={
  ...
  symbol:'BTCUSDT',market:'LINEAR_PERPETUAL',strategyAuthority:'STATE_FIRST_STRUCTURE_FLOW_LIQUIDITY_DERIVATIVES',migrationState:'BTC_ONLY_COMPLETE',dailyTradeQuota:'NONE',riskAuthority:'ADAPTIVE_FULL_ACCOUNT_EQUITY_BALANCE_SCALE'
};
