...
export const BYBIT_RUNTIME_CONTRACT={
  ...
  symbol:'BTCUSDT',market:'LINEAR_PERPETUAL',strategyAuthority:'STATE_FIRST_STRUCTURE_FLOW_LIQUIDITY_DERIVATIVES',migrationState:'BTC_ONLY_COMPLETE',dailyTradeQuota:'NONE',riskAuthority:'ADAPTIVE_FULL_ACCOUNT_BALANCE_EQUITY_SCALE',balanceAuthority:'BYBIT_WALLET_PLUS_TRANSACTION_LOG',depositWithdrawalAware:true,unrealizedScaleCreditPct:25
};
