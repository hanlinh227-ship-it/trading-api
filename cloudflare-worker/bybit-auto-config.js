...
export const BYBIT_AUTO_CONFIG={
  ...
  risk:{
    ...
    aPlusEntryRiskPct:1.25,
    absoluteSingleEntryRiskPct:1.50,
  ...
  regime:{
    states:["TREND_UP","TREND_DOWN","RANGE","SQUEEZE","BREAKOUT_UP","BREAKOUT_DOWN","REVERSAL","HIGH_VOL_SHOCK","TRANSITION"]
  },
  features:{
    ...
    basis:true,
    longShortRatio:true,
    realizedVolatility:true,
    indicatorsSupportingOnly:true
  },
  entries:{
    trendPullback:true,
    trendContinuation:true,
    breakoutRetest:true,
    rangeMeanReversion:true,
  ...
  execution:{
    ...
    requirePostOrderReconciliation:true,
    requireProtectionConfirmation:true,
