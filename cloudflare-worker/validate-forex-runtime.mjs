...
need(ai,['requestedProviders:["claude","codex"]','UNIFIED_2AI_VPC_BRIDGE','entryCandidates may contain up to 3','UP_TO_3_AI_CANDIDATES_COMMON_SYMBOL_SIDE_ORDER_TYPE','2AI_NO_COMMON_TRADABLE_CANDIDATE','candidateOverlapCount','MARKET|LIMIT|STOP','pendingOrdersCancelledOnRedNews'],'FOREX_2AI');
