...
export function selectModelWorkers({profile='STANDARD',domain='core',dataClass='PUBLIC',models=[],contextTokens=0,requiredCapability='text_reasoning',hardCapabilities=[],nowMs=Date.now()}={}){
