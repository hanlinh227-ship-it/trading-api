...
const model={provider_id:'groq',model_id:'free-model',model_family:'family-free',free_status:'recurring',health:'healthy',privacy_class:'public_safe',capabilities:{text_reasoning:{supported:true,score:0.9}},quality_scores:{core:0.9}};
