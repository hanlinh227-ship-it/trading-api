...
if(!hub.includes('providerFailures'))errors.push('V11 scan observability must expose providerFailures');
if(!hub.includes('PROVIDER_FAILURE'))errors.push('V11 funnel must distinguish provider failures');
