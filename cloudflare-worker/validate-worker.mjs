...
for(const needle of ['MEME-AUTO-0.2.0-DESIGN','MEME_AUTO_MODE="DESIGN_ONLY"','executionEnabled:false','walletConnected:false','signingEnabled:false','BALANCE_AWARE_CONTINUOUS_ALLOCATOR','autoScaleWithBalance:true','autoDeRiskWithDrawdown:true','computeMemeCapitalPlan','allocationTiers','drawdownMultipliers','liquidityParticipationCapPct:0.05','minimumOperatingBalanceUsd:20','scaleDownImmediatelyOnBalanceLoss:true','scaleUpOnlyFromCurrentConfirmedEquity:true','blindLaunchSniping:false','requireExecutableSellRouteBeforeEntry:true','minLiquidityUsd:30000','maxTop10HolderPct:35','maxDevInsiderSupplyPct:8','maxBundlerSupplyPct:12','maxSniperSupplyPct:18','watchScore:78','entryScore:85','premiumScore:92','MOMENTUM_RETEST','FRESH_BREAKOUT','EARLY_ROTATION','principalRecovery:true','runner:true','autoPromote:false'])if(!meme.includes(needle))errors.push(`MEME design invariant missing ${needle}`);
...
console.log('Worker AUTO preflight PASS: Unified Hub + Bybit Auto 1.4.1 LIVE + MEME-AUTO 0.2.0 balance-aware design-only allocator + safety/execution locks.');
