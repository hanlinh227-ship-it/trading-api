...
walk(root);
const required=['index.js','hub-v11.js','v11/native-runtime.js','v11/manual-market-hunter.js','v11/entry-plan.js','v11/market-policies.js','v11/store.js','engine-v77168.js','bybit-control-plane.js','bybit-readonly-health.js','bybit-auto-v1.js','bybit-scalp-engine.js','multi-ai-control-plane.js','providers/telegram-client.js'];
...
console.log('Worker V11 preflight PASS: Signal V11 source-of-truth, private VPC AI council and separate Bybit Auto execution locked.');
