...
walk(root);
const required=['index.js','hub-v11.js','v11/native-runtime.js','v11/manual-market-hunter.js','v11/ai-gateway.js','v11/entry-plan.js','v11/market-policies.js','v11/store.js','engine-v77168.js','binance-control-plane.js','multi-ai-control-plane.js','providers/telegram-client.js'];
...
console.log('Worker V11 preflight PASS: V11 source-of-truth, native scheduler, private VPC AI bridge and OIDC Multi-AI gateway locked.');
