...
console.log('Worker AUTO preflight PASS: Bybit Auto Hub only + Telegram entry alerts + 3AI + continuous trading + daily target OFF + Smart CUT + global spacing/loss pause + hard protection locked.');
