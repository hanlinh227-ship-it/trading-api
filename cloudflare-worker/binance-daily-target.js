export function dailyTargetPolicy(env,state={},equityUsd=0){
  ...
  return {targetUsd,realizedUsd:realized,remainingUsd:remaining,reached,progressPct:pct*100,targetPctOfEquity:targetPct,forceTrade:false,forceRiskIncrease:false};
}
