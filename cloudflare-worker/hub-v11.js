...
export default {
 async fetch(req,env,ctx){
  ...
  if(url.pathname==='/v11/status')return json({ok:true,version:'V11',telegram:true,maxOpenPerMarket:5,reevaluationCut:true,aiCutConsensusRequired:4,canonicalLiveQuoteRouter:true});
