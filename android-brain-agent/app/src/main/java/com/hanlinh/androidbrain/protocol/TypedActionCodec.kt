        ...
        return try {
            when (json.getString("type")) {
                ...
                "swipe" -> Swipe(
                    ...
                    json.getInt("endX"), json.getInt("endY"), json.getLong("durationMs"),
                )
                ...
                "scroll_node" -> ScrollNode(
                    json.requiredString("nodeId"),
                    ScrollDirection.valueOf(json.requiredString("direction")),
                )
