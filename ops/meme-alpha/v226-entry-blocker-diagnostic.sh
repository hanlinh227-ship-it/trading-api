...
const directRisk=read(`${P}/risk-state.json`);
const risk=Object.keys(directRisk).length?directRisk:(sig.risk||{});
...
console.log('CURRENT_LIVE_TREND_RISK_DIAGNOSTIC_PASS');
NODE
