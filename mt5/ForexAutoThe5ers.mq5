#property strict
#property version   "0.602"
#property description "FOREX AUTO The5ers PURE AI ULTRA LOW LATENCY - GPT + Claude own entry and position management; EA is transport/execution/safety only."

input string InpHubUrl="https://YOUR-WORKER.workers.dev";
input string InpBridgeToken="";
input bool InpAllowLiveTrading=false;
input int InpPulseSeconds=2;
input double InpMaxRiskPct=1.00;
input double InpMinFreeMarginPct=20.0;
input double InpMinMarginLevelPct=200.0;
input int InpMagic=560602;
