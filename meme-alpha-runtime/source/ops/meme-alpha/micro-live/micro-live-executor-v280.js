...
function normalizeState(st){
  ...
  st.version='2.8.0';st.closed=n(st.closed);st.position=st.position||null;
  if(st.position){
...
if(process.argv.includes('--self-test')){
  ...
  console.log('MICRO_EXECUTOR_V280_SELF_TEST=PASS');console.log('STAGED_UTILIZATION=15_35_65_94 OPPORTUNITY_ENTRY=9_10_TARGET');console.log('ABSOLUTE_RESERVE_SOL=0.010');console.log('MIN_REAL_ORDER_SOL=0.010');console.log('EXTERNAL_DEPOSIT_WITHDRAWAL_AWARE=TRUE');console.log('NETWORK_EXECUTION=NOT_CALLED');
