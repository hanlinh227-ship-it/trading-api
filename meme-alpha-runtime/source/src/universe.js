...
const CANONICAL_MEME_MINTS=new Set(['EKpQGSJtjMFqKZ9KQanSqYXRcF8fBopzLHYxdM65zcjm','2zMMhcVQEXDtdE6vsFS7S7D5oUodfJHE8vd1gnBouauv','63LfDmNb3MQ8mw9MtZ2To9bEA2M71kZUUGq5tiJxcqj9']);
...
scan.universe={version:'1.6.1',filteredAt:new Date().toISOString(),policy:'POSITIVE_MEME_EVIDENCE_FAIL_CLOSED',memeConfirmed:confirmed,memeProbable:probable,nonMemeBlocked:nonMeme,unclassifiedBlocked:unclassified,unknownEntryEligible:false};
