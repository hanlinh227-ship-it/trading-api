...
if(process.argv.includes('--self-test')){
  ...
  console.log('MICRO_EXECUTOR_V360_PROFIT_AWARE_SELF_TEST=PASS');console.log('CONTINUOUS_ALLOCATION=TRUE');console.log('CAPITAL_UTILIZATION_FIRST=TRUE');console.log('FREE_CAPITAL_BOOSTS_NEW_BUYS=TRUE');console.log('EQUITY_GROWTH_SCALES_NEW_BUYS=TRUE');console.log('DYNAMIC_NETWORK_EXIT_HEADROOM=TRUE');console.log('MULTI_POSITION_NO_HARD_COUNT_LIMIT=TRUE');console.log('ROTATION_TO_STRONGER_OPPORTUNITY=TRUE');console.log('HARD_SECURITY_AND_SELLABILITY_FAILSAFE=KEPT');console.log('REALTIME_POOL_PULSE_INTEGRATION=TRUE');console.log('ONCHAIN_WHALE_FLOW_INTEGRATION=TRUE');console.log('ONLINE_EXPECTANCY_LEARNING=TRUE');console.log('OPPORTUNITY_COST_ROTATION=TRUE');console.log('JITO_REGION_RACE_WITH_SAFE_FALLBACK=TRUE');console.log('EXECUTION_FEEDBACK_LOOP=TRUE');console.log('ADAPTIVE_FAST_LOOP_MS=1500');console.log('NETWORK_EXECUTION=NOT_CALLED');
