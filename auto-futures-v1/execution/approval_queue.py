...
def main():
    ...
    if slots<=0:
        ...
        for item in old.get('items',[]):
            ...
            items.append(item)
        payload={'generated_at':t.isoformat(),'capacity':{'open_positions':open_positions,'max_open_positions':MAX_OPEN_POSITIONS,'available_slots':0,'telegram_new_trade_notifications':False},'policy':{'confirmation_required':True,'live_preflight_required':True,'missed_signal_action':'EXPIRE_NO_TRADE','suppress_new_signals_when_full':True},'items':items[-100:]}
